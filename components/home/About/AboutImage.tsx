...
export default function AboutImage({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-4 rounded-theme bg-theme-surface px-5 py-4 shadow-xl md:-bottom-8 md:-right-8 md:rounded-theme md:p-6">
        <h3 className="text-2xl font-bold text-theme-primary md:text-4xl">
          8+
        </h3>
